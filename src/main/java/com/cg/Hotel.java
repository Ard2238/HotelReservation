...
public class Hotel {
    ...
    public int getWeekendRate_Reward() { return weekendRate_Reward; }

    public void setWeekendRate_Reward(int weekendRate_Reward) { this.weekendRate_Reward = weekendRate_Reward; }
